...
thermalProperties(thermalmodel,'ThermalConductivity',1000,...
                               'MassDensity',1,...
                               'SpecificHeat',1);
internalHeatSource(thermalmodel,0);

%% BC
leftHF = @(~,state) 1+0.5*sin(-pi/2+10*state.time);
thermalBC(thermalmodel,'Edge',23,'Temperature',leftHF);
...
% pdeplot(thermalmodel,'XYData',T(:,4),'ColorMap','jet')
% xlim([0,800]);
% ylim([0,800]);
% xlabel('$x$','FontUnits','points','interpreter','latex',...
%     'FontSize',10);
...
% pdeplot(thermalmodel,'XYData',T(:,10),'ColorMap','jet')
% xlim([0,800]);
% ylim([0,800]);
% xlabel('$x$','FontUnits','points','interpreter','latex',...
%     'FontSize',10);
...
% pdeplot(thermalmodel,'XYData',T(:,20),'ColorMap','jet')
% xlim([0,800]);
% ylim([0,800]);
% c3 = colorbar;
